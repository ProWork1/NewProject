...
const BreadcrumbsComponent = props => {
    ...
    return (
        <div id='breadcrumbs' className='mt-3 mb-5'>
            <Container>
                <div className='d-flex'>
                    ...
                    {breadcrumbs.title2 ? (
                        <Link to={breadcrumbs.link1} className='title'>
                            {breadcrumbs.title1}
                        </Link>
                    ) : (
                        <div className='title1'>{breadcrumbs.title1}</div>
                    )}
                    {breadcrumbs.title2 ? (
                        <>
                            <div className='title'>{'>'}</div>
                            <div className='title1'>{breadcrumbs.title2}</div>
                        </>
                    ) : (
                        ''
                    )}
