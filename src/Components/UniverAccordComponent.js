                    ...
                    <div className="accordion__border">
                        <Card.Header className="accordion__header  ">
                            <Accordion.Toggle onClick={() => setPlusMinus(!plusMinus)} as={Button} eventKey="0"
                                              className={plusMinus ? "shadow-none accordion__btn univer__btn" : "shadow-none accordion__btn color-dark"}>
                                    ...
                                    {[...new Array(5)].map((index) =>
                                        <Col key={index}>
                                            <ul className="navbar-nav">
                                                <li className="nav-item"><p className="nav-text"></p></li>
                                                <li className="nav-item"><p className="nav-text">Архитектура</p></li>
                                                <li className="nav-item"><p className="nav-text">Архитектура</p></li>
                                                <li className="nav-item"><p className="nav-text">Архитектура</p></li>
                                                <li className="nav-item"><p className="nav-text">Архитектура</p></li>
                                                <li className="nav-item"><p className="nav-text">Архитектура</p></li>
