            ...
            <div className="body">
                    ...
                    <div className="col-12 col-md-6">
                        <div className="form-group">
                            ...
                            <div className="d-flex">
                                <input type="number" className="form-control date-day" placeholder="День" />
                                ...
                                <input type="text" className="form-control date-year" placeholder="Год" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="row align-items-end m-0 pt-4">
                    <div className="col-12 col-md-6">
                        ...
                        <div className="form-group pt-2">
                            <MaskedInput className="form-control" placeholder="+998 (____) ___ - __ - __"
                ...
                <div className="row m-0 pt-4 pb-5">
                    <div className="col-12 col-md-6">
                        <div className="form-group">
                            <textarea className="form-control" placeholder="Дополнительные комментарии" />
                        </div>
                    </div>
                </div>
