    ...
    return (
        <div>
            <div className="slider__relative mt-5">
                <Swiper navigation={true} pagination={{clickable: true}} spaceBetween={20} className={"mySwiper"}
                        slidesPerView={1}
                        autoplay={true}>
                    {[...new Array(10)].map((index) => (
                        <SwiperSlide key={index}>
                            <div className="img-wrapper">
                                <img src="images/image 36.png" width={850} alt="slider image" className="slider__img"/>
                            </div>
                        </SwiperSlide>
                    ))}
                </Swiper>
