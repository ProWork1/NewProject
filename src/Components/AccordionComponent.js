                ...
                <Card className="border-0 accordion__parent">
                    <div className="accordion__border">
                        <Card.Header className="accordion__header">
                            ...
                            <span className="accordion__title">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod?</span>
                        </Card.Header>
                        <Accordion.Collapse eventKey="0">
                            <Card.Body className="accordion__body">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                                exercitation. Lorem ipsum dolor sit amet, consectetur adipiscing elit! Lorem ipsum dolor
                                sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                                dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation. Lorem ipsum
